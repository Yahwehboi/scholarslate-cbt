    ...
    >
      ...
      >
        ...
        <p className="text-sm mb-8" style={{ color: '#3d4a3d', lineHeight: 1.6 }}>
          Once you start, the timer begins immediately. Make sure you are in a quiet environment with a stable connection.
        </p>
  ...
  return (
    ...
    >
      <div className="flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center transition-colors duration-200"
        ...
        onMouseEnter={e => {
          (e.currentTarget as HTMLElement).style.backgroundColor = '#e8f5ed'
          ;(e.currentTarget as HTMLElement).style.color = '#006e2f'
        }}
        onMouseLeave={e => {
          (e.currentTarget as HTMLElement).style.backgroundColor = '#e7e8e9'
          ;(e.currentTarget as HTMLElement).style.color = '#3d4a3d'
        }}
      >
        {icon}
      </div>
...
export default function InstructionsPage() {
  ...
  const rules = [
    { icon: Ic.list,      title: 'Total Questions',   desc: 'This examination contains 50 multiple-choice questions. All questions carry equal marks.' },
  ...
  return (
    <>
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#f8f9fa' }}>
        ...
        {/* Top bar — simplified (no sidebar on this page per design) */}
        ...
        <main className="min-h-[calc(100vh-64px)] flex items-center justify-center p-5 md:p-10">
          <div className="w-full max-w-4xl relative">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-5 mb-10">
                ...
                >
                  <div className="text-right">
                    ...
                    <p className="text-xl font-bold" style={{ fontFamily: 'Manrope,sans-serif', color: '#191c1d' }}>60 Minutes</p>
                  </div>
                  ...
                  <div className="p-6 rounded-xl flex flex-col gap-5" style={{ backgroundColor: '#f3f4f5' }}>
                    ...
                    <div className="space-y-3 pt-4" style={{ borderTop: '1px solid rgba(188,203,185,0.3)' }}>
                      {[
                        ...
                        { label: 'Questions', value: '50 MCQ' },
                        { label: 'Duration',  value: '60 Minutes' },
                        { label: 'Attempt',   value: '1 of 2' },
              ...
              >
                By clicking "I Understand, Start Exam", you acknowledge that you have read and understood the rules and procedures for this CBT session. All actions are logged for security and integrity purposes.
              </motion.p>
